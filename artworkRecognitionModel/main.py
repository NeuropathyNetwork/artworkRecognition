...
def Train_Testloader(data):
    ...
    train_loader = DataLoader(train_dataset, batch_size=16, shuffle=True, num_workers=10, pin_memory=True)
    test_loader = DataLoader(test_dataset, batch_size=16, shuffle=False, num_workers=10, pin_memory=True)
...
if __name__ == '__main__':
    ...
    mp.freeze_support()  # Optional, can be omitted if not freezing the program
